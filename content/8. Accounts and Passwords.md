...
- In Account and Password -> Two-factor authentication - after you have set up [[8. Accounts and Passwords#2 Factor Authentication]] security keys and TOTP, enable and set up both.
...
* In Account Settings -> Two-factor authentication - after you have set up [[8. Accounts and Passwords#2 Factor Authentication]] security keys and TOTP, enable and set up both.
...
Aliases can be generated within SimpleLogin web view or within Bitwarden as part of the credential creation process. This process uses the API key we just saved. Refer to [[8. Accounts and Passwords#Creating new accounts]] for instructions on creating within Bitwarden.
...
* Enable two step login (2FA) to the vault with a security token.
	...
	* Obtain and setup **three** security keys - [[8. Accounts and Passwords#Token2 Security Keys]].
...
* After configuring many services, it becomes apparent that if you were to lose your phone, you would lose access to these 2FA codes, locking you out of accounts. You can backup these codes -
	...
	* If you follow [[5. Secure Backups and Documents]], the codes will be copied to a disc when we make a snapshot of the phone. Otherwise, navigate to the folder and copy it to your computer and store safely.
### Using TOTP
...
More info and other strategies can be found in [[7. Private Payments]].
## Biometric Data
...
* Configure [[8. Accounts and Passwords#2 Factor Authentication]] within the service
...
7. Configure [[8. Accounts and Passwords#2 Factor Authentication]].
