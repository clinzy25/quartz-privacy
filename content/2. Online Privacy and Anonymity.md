...
If you believe in the founding principles of the free world, that power rests with the people, then we should value privacy as a democratic principle and fight for it.
...
- Your ISP also knows various details about your home network - how many and what type of devices you have, your network configuration, and usage patterns (when devices connect/disconnect, sleep schedules). These can be used to make inferences about your daily routine and household activity.
## IP Based Tracking
When you connect a device to the internet, it is assigned an IP address. This is a globally unique identifier that is used for identification and tracking. In the US, this identifier is not typically cycled, meaning you could have the same IP attached to your device for years. This is convenient for ad companies who can cross-reference your traffic between sites and build a profile on you to sell to other entities and target you with ads. IP addresses can also be approximately geolocated - good enough for regional ad targeting but not accurate enough to pinpoint your address.
...
Cookies are bits of code embedded onto your device by websites you visit, apps you use, and emails you open. They are often used to track your internet activity, send it to various third parties, and build behavior profiles for ad targeting. Practically every website embeds cookies when you load the page, and they linger indefinitely after leaving the page. Account based cookies are embedded when you log into accounts and can persist after logging out.
## Browser Based Tracking
Using a proprietary browser like Chrome, Edge, or Safari transmits all of your internet activity to Google, Microsoft or Apple respectively.
## DNS Logging
...
# Threat Response
Against this long list of threats, full anonymity and privacy is practically impossible. Our goal is to find the right balance between privacy and functionality, and have high standards of trust for the tools that we will use to respond to these threats.

Two simple tools mitigate most of the above threats - VPNs and custom, secure DNS servers. We will configure these in the following sections.

Your choice of browser also has privacy implications and is discussed in detail [[3. Private Browsers]]

Further, we can adopt patterns of behavior and use simple common sense when using the internet to mitigate threats. Simply using discretion about what sites you visit, what services you use, and what links you click on is a huge step in the right direction.
...
- This is an effective opt-out of third-party data sharing. You provide nothing of value to your ISP, and websites cannot exploit your IP address. You are still vulnerable to tracking.
