This section explains privacy risks associated with regular internet traffic from your home network and phone - who can see your web activity and how you can be identified. We will discuss three main mitigation strategies - VPNs, secure DNS servers, and hardened web browsers with detailed setup instructions for each. It is important to distinguish between privacy and anonymity for this guide -
- Privacy - who can see your data
- Anonymity - whether that data is associated with you
---
It is important to understand fact that all online activity leaves traces - traces that are valuable to a large number of profit motivated entities who are under no legal or moral obligation to respect your privacy. An entire sector of the US economy trades online behavioral data generated from benign user interactions, usually to fine-tune ad targeting precision. This market is strategically opaque so as to keep users from understanding its mechanisms so that it can escape social backlash and government regulation while continuing to produce profits.

While most of the threats discussed here are from the private sector, no legal barriers exist between these companies and the government. In America, the Supreme Court upholds [Third Patry Doctrine](https://ij.org/issues/ijs-project-on-the-4th-amendment/third-party-doctrine/), which states that information shared to third parties loses all constitutional protection. You can assume that any entity that has your information can be compelled to produce it in response to a court order from law enforcement.
...
No matter how benign your use of technology is, how boring you think you are, or how little you break the law, this stuff matters. We should be opposed to being spied on regardless of what we are doing. Our conversations, curiosities, and personalities are not resources to be extracted and were never intended to be stored indefinitely by someone other than us, in a place other than our home. In this domain, inches given are miles taken; shoot first and ask questions later - do the unethical or legally questionable thing now, without asking, and profit while the people and government debate how to respond.

Observe the trends - driven by an obligation to infinite growth, these companies race to find untapped domains of human experience to extract, as evidenced by the rise of Internet of Things devices and wearable tech. The same trend can be observed in the rising sophistication on online tracking - clicks, swipes, keystrokes, mouse movement, hesitations, current location, past locations, websites you've visited, emails you've clicked on, your conversations, your posts - all valuable data that is enriched when associated with a name, gender, address, race, income, government ID, etc.

Remember that information confers power. It doesn't take a wild imagination to run this scenario forward and see where we end up. At present they say it is for advertisements, but in the future it **will** be used for more than that.

Like it or not, a great deal of modern life has been transferred to the internet. Those aspects of life, in times past, had no microphones attached to our shirt, no cameras in our face, and no satellites looking down on us. Our lives were not intricately modeled in distant, walled-off data centers and sold to the highest bidder. If you believe that power rests with the people, then we should value online privacy as a democratic principle and fight for it.

And we can fight for it - privacy tools have become quite sophisticated as well. With a small set of easily configurable online tools, we can claw back most of our online privacy, and effectively opt-out of surveillance and the abuse of our information.
# Threat Model
...
Additionally and on a simpler note, all of your activity and personal information on these platforms is collected, stored, sold, fed to ML models, and distributed fractally to numerous third-parties, even things that should be private like emails and cloud storage contents.
...
To determine if a service is trustworthy, read their privacy policy to determine a companies level of survellience. CTRL + F is your friend, search for things like "sell", "third parties", "stored", etc.

If you must access one of these services, as we need to on occasion, you can use container tabs. This is an extension for Firefox and an experimental feature for Brave that can be turned on ([[2. Online Privacy and Anonymity#Browser Settings]]). Containers are isolated browsing sessions and they have their own cookie storage. Websites in container tabs cannot get any information about the rest of the browsing session, foiling any cross-site tracking attempts.
