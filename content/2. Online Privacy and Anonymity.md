...
Because we have done a lot of work to anonymize our web traffic and block trackers at the device level, we can narrow our threat model for browsers a bit - we will focus on security, fingerprinting, and telemetry. We will still install a browser-based ad blocker to cover some things that DNS tracking protection might miss, but this is an extension and not a native browser feature.

We want to take into account privacy, security, and anonymity for our choice of browser, looking for the following characteristics -
- A non-proprietary product from a big tech company that collects your data or seeks to build and sell user profiles. This immediately rules out Chrome, Edge, Safari, or Firefox. A note on Firefox - until 2025, Firefox was a solid choice for privacy, but they have recently introduced a dubious [Terms of Use](https://www.mozilla.org/en-US/about/legal/terms/firefox/) and [updated their privacy language](https://github.com/mozilla/bedrock/pull/16018/files) to remove promises that they would never sell user data.
...
- Good security track record - widely adopted, strong track record, frequent updates, and timely security patches.
- Good balance of usability and privacy - anti-tracking mechanisms can degrade user experience.
## Choosing a Browser
We have few different modern, privacy-centric browsers to choose from, all with various advantages and disadvantages.
- Brave
- Tor Browser
- Mullvad Browser
- Librewolf
...
- Privacy and security
	...
	- Security -> Use secure DNS - Turn this off so Brave will default to our NextDNS connection.
...
## Browsing Behavior
!TODO
- Close browser when done using it
- Container tabs
- Dont click bad links dont go to bad sites
- Dont follow HTTP or expired SSL certs
- Dont download dumb stuff (executables)
